  ...
  return (
    ...
    >
      <div className="relative w-full h-full">
        ...
        {/* User Name */}
        <p className="absolute top-1/2 w-full text-center text-black text-[80px] font-headline" style={{ transform: 'translateY(-100%)', fontWeight: 900 }}>
          {name}
        </p>

        {/* Encouraging Message */}
        <div className="absolute top-1/2 w-full text-center px-[220px]" style={{ transform: 'translateY(-10%)' }}>
        ...
        {/* Date */}
        <p className="absolute bottom-[173px] left-[190px] text-black text-[22px] font-semibold">
          {dateStr}
        </p>
      </div>
    </div>
